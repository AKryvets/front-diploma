...
import { CheckboxField } from '../../../packages/form-fields/checkbox';
import { InputField } from '../../../packages/form-fields/input';

import { Text } from '../../../styled';
import { DefaultColors } from '../../../theme';

import { COMPLETE_TEST, QuestionsTypes } from './consts';
              ...
              if (question.type === QuestionsTypes.Input) {
                return (
                  <FormFieldWrapper>
                    ...
                    />
                    <AnswerWrapper>
                      <Text color={DefaultColors.green}>
                        Right answers: a,f,a,d
                      </Text>
                    </AnswerWrapper>
                  </FormFieldWrapper>
                );
